...
export default class CtaOne extends Component {
    stateList = {
        img: require('../../../assets/images/89354.webp'),
        lists: [
            {
                icon: <GoFile />,
                            ...
                            <div className="col-lg-6 ml-auto">
                                <div className="mobile-app-content">
                                    ...
                                    <div className="btn-box text-left margin-top-40px">                                        
                                      <a className="down-btn" target="_blank" href="https://drive.google.com/file/d/1QUWOqTF7rRhF3nk9FXx9ZVEiu-Djb_rM/view?usp=sharing"><span className="btn_icon"><AiFillAndroid /></span> Download android app</a>
