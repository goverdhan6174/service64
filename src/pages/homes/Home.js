                ...
                <section className="cat-area padding-top-80 padding-bottom-80px">
                    <div className="container">
                        ...
                        <div className="">
                            ...
                            <p className="h_raw_text">You can find the most trusted and hardworking people here to answer your calls in the <a href="https://service64.com/categories">category list.</a></p>
                        </div>
                   ...
                   {/* 
                    ...
                    <div className="container margintop2">
                ...
                <section className="hiw-area text-center padding-top-80px padding-bottom-110px">
                    <div className="container">
                        <div className="">
                            ...
                            <p className="h_raw_text">Here we have a directory of hand vetted <a href="https://service64.com/list">service providers</a> with the most responsive and professional service reputation.</p>
                        </div>
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-9 text-left">
                                <SectionsHeading title="We can help you get a job that you love doing" titleClass=" mb-3 font-size-28" 
                                descClass=" font-size-17" desc="Don't have any shop or contact address to get your customers? We are here to help you to get calls from the people who are looking for your service." />
                            </div>
