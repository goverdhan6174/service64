...
import { get_listing_usr, del_listing, listing_details, get_loc, edit_listing, get_cat, edit_buyer_profile, pwd_reset } from '../../store/action';
...
class Dashboard extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            userbio: 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantiumlocations[0]',
    ...
    componentDidMount() {
        ...
        if (current_user !== null) {
            ...
            if (current_user.user_type === "Seller") {
                ...
                this.props.actions.get_listing_usr({ _id: current_user._id }).then((res) => {
                    const data = res.data[0]
                    localStorage.setItem('__current_user__', JSON.stringify(data))
    ...
    updateSellerListing() {
        ...
        if (fullname.length < 1) {
            ...
            this.setState({
                changeDetailsErrMsg: "An effective overview needs to be at least 40 to 400 characters",
            });
        } else if (category === "") {
            this.setState({
            ...
            this.props.actions.edit_listing(saller).then((res) => {
    ...
    updateBuyerListing() {
        if (this.state.fullname.length < 2) {
            ...
            this.props.actions.edit_buyer_profile(buyer).then((res) => {
                if (res.data !== undefined) {
    ...
    updatePass() {
        if (this.state.currentPass.length < 8) {
            ...
            this.props.actions.pwd_reset(body).then((res) => {
                console.log(res);
                if (res.data.resulte) {
                    this.setState({
    ...
    item_del() {
        ...
        this.props.actions.del_listing({ _id: user_id })
            .then((response) => {
    ...
    render() {
        const { imgUpload, loading, cards, items, is_logedin, user_type, cities, selected_city, locations, description, selected_location, location, categories, category, profileEdit, city } = this.state
        return (
                                        ...
                                        <TabList className="nav nav-tabs border-0" id="nav-tab">
                                            <Tab>
                                                <Link className="nav-item nav-link theme-btn pt-0 pb-0 mr-1" to="#">
                                                    <span className="la"><AiOutlineUser /></span> Edit Profile
                                                </Link>
                                            </Tab>
                                            <Tab>
                                                <Link className="nav-item nav-link theme-btn pt-0 pb-0 mr-1" to="#">
                                                    <span className="la"><BsListCheck /></span> My Profile
                                                </Link>
                                            </Tab>
                                        </TabList>
                                                            ...
                                                            {user_type &&
                                                                <div className="billing-form-item">
                                                                    <div className="billing-title-wrap">
                                                                        <h3 className="widget-title pb-0">Change Details</h3>
                                                                    ...
                                                                    <div className="contact-form-action">
                                                                        <div className="input-box">
                                                                            ...
                                                                            <div className="form-group">
                                                                                <span className="la form-icon"><BsLock /></span>
                                                                                <input className="form-control" type="password" name="currentPass" value={this.state.currentPass} onChange={this.value.bind(this)} placeholder="Current Password" />
                                                                            </div>
                                                                        </div>
                                                                        <div className="input-box">
                                                                            ...
                                                                            <div className="form-group">
                                                                                <span className="la form-icon"><BsLock /></span>
                                                                                <input className="form-control" type="password" name="newPass" value={this.state.newPass} onChange={this.value.bind(this)} placeholder="New Password" />
                                                                            </div>
                                                                        </div>
                                                                        <div className="input-box">
                                                                            ...
                                                                            <div className="form-group">
                                                                                <span className="la form-icon"><BsLock /></span>
                                                                                <input className="form-control" type="password" name="confirmPass" value={this.state.confirmPass} onChange={this.value.bind(this)} placeholder="Confirm New Password" />
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div className="btn-box">
                                                                            <button className="theme-btn button-success border-0" onClick={this.updatePass.bind(this)} >
                                                                                updated password
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                                ...
                                                                                {!profileEdit &&
                                                                                    <>
                                                                                        ...
                                                                                        <ul className="list-items mt-3">
                                                                                            <li>
                                                                                                <span className="la d-inline-block"><GiPositionMarker /></span> Working Areas:
                                                                                                {this.state.location.length > 1 &&

                                                                                                    this.state.city + ', ' + this.state.location[0] + ', (' + (this.state.location.length - 1) + ' more) '}

                                                                                                {this.state.location.length < 2 &&

                                                                                                    this.state.city + ' ' + this.state.location[0]}

                                                                                            </li>
                                                                                            <li className="">
                                                                                                <span className="la d-inline-block"><FiPhone /></span> Phone Number: {this.state.phone_number}
                                                                                            </li>
                                                                                        </ul>
                                                                                        <div className="edit-form mt-4">
                                                                                            <button
                                                                                                onClick={() => { this.setState({ profileEdit: true }) }}
                                                                                                className="theme-btn edit-btn border-0 after-none"
                                                                                                type="button"
                                                                                                aria-haspopup="true"
                                                                                                aria-expanded="false">
                                                                                                <i className="la"><FiEdit /></i> Edit Details</button>
                                                                                        </div>
                                                                                    </>
                                                                                }
                                                                                            ...
                                                                                            <div className="contact-form-action">
                                                                                                <div className="input-box">
                                                                                                    <div className="form-group">
                                                                                                        ...
                                                                                                        <input className="form-control" type="text" name="fullname" placeholder="Enter your name" value={this.state.fullname} onChange={this.value.bind(this)} />
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div className="input-box">
                                                                                                    <label className="label-text">Discription</label>
                                                                                                    <div className="form-group">
                                                                                                        <span className="la form-icon"><BsPencil /></span>
                                                                                                        <textarea className="message-control form-control" name="description" placeholder="Add Discription" value={this.state.description} onChange={this.value.bind(this)} ></textarea>
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div className="input-box">
                                                                                                    <div className="form-group">
                                                                                                        ...
                                                                                                        <input className="form-control" type="text" name="phone_number" placeholder="Number" value={this.state.phone_number} onChange={this.value.bind(this)} />
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div className="btn-box">
                                                                                                    <button type="submit" className="theme-btn border-0 button-success mr-1" onClick={this.updateSellerListing.bind(this)} >save changes</button>

                                                                                                    <button type="button" onClick={() => { this.setState({ profileEdit: false }) }} className="theme-btn border-0">
                                                                                                        Cancel
                    </button>
                                                                                                </div>
                                                                                            </div>
                                                                                ...
                                                                                <div className="contact-form-action">
                                                                                    ...
                                                                                    <div className="input-box">
                                                                                        ...
                                                                                        <div className="form-group">
                                                                                            ...
                                                                                            <input className="form-control" type="email" name="email" placeholder="Email Address" value={this.state.email} onChange={this.value.bind(this)} />
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div className="btn-box">
                                                                                        <button type="button" className="theme-btn border-0 button-success mr-1" onClick={this.updateBuyerListing.bind(this)} >save changes</button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <div className="card-content-wrap">
                                                                                    <div className="card-content">
                                                                                        <div onClick={this.get_listing_detailes.bind(this, item)} style={{ cursor: 'pointer' }}>
                                                                                            ...
                                                                                            <p className="card-sub">{'Location: ' + item.locations[0] + ', ' + item.city}</p>
                                                                                        </div>
                                                                                    </div>
...
const mapDispatchToProps = (dispatchEvent) => {
    return {
        actions: bindActionCreators({
            get_listing_usr, del_listing, listing_details, get_loc, edit_listing, get_cat, edit_buyer_profile, pwd_reset
        }, dispatchEvent),
    }
}
